...
| [es/STAT_PROFILES.md](./es/STAT_PROFILES.md) | Perfiles de distribución de stats basados en tipos y ejemplos | Type-based stat distribution profiles and examples |
